...
import { loginService, loginViaGoogle } from "services/SessionService";
  ...
  return (
    <div className={styles.loginForm}>
      <div className={styles.loginViaView}>
        ...
        />
        <FacebookAuthButton
          onGetUserInfo={(userInfo) => { console.log(userInfo) }}
          onErr={(err) => {
            console.log(err)
          }}
        />
          ...
          <Form
            ...
            <h3 className={styles.formSignUpText}>
              <p>Create new account?
                <span>
                  <Link className={styles.link} href={PATH.SignUp}>Sign Up</Link>
                </span>
              </p>
            </h3>
          </Form>
